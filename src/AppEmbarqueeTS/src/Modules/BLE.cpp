...
{
    this->_CRStatsCaracteristic = new BLECharacteristic(BLE_COMPLETED_RIDE_CARACTRISTIC_STATS, BLECharacteristic::PROPERTY_READ);
    ...
    this->_completedRideService->addCharacteristic(this->_CRStatsCaracteristic);

    this->_CRPointsCaracteristic = new BLECharacteristic(BLE_COMPLETED_RIDE_CHARACTERISTIC_POINTS, BLECharacteristic::PROPERTY_READ);
    ...
    this->_completedRideService->addCharacteristic(this->_CRPointsCaracteristic);
   
    this->_CRIsReadyCaracteristic = new BLECharacteristic(BLE_COMPLETED_RIDE_CHARACTERISTIC_IS_READY, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_NOTIFY);
    this->_CRIsReadyCaracteristic->setValue("false");
    this->_completedRideService->addCharacteristic(this->_CRIsReadyCaracteristic);

    this->_CRIsReceivedCaracteristic = new BLECharacteristic(BLE_COMPLETED_RIDE_CHARACTERISTIC_IS_RECEIVED, BLECharacteristic::PROPERTY_READ | BLECharacteristic::PROPERTY_WRITE);
    this->_CRIsReceivedCaracteristic->setValue("false");
    this->_completedRideService->addCharacteristic(this->_CRIsReceivedCaracteristic);
